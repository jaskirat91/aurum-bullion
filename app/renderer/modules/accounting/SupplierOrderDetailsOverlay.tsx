...
export function SupplierOrderDetailsOverlay({ voucherId, onClose, onEdit, onCancelled }: DetailsProps) {
        ...
        <div className="shrink-0 px-6 py-4 border-b border-border bg-background/30 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] font-black uppercase text-text-muted tracking-widest leading-none mt-0.5">Supplier Order Details</p>
            </div>
          </div>
