...
export type ElectronAPI = {
  ...
  listFinishedProducts: (filter: any) => Promise<IPCResult<{ items: any[]; total: number; totals?: any }>>;
  ...
  getPartyLedgerReport: (filters: { partyIds?: string[]; startDate?: string; endDate?: string }) => Promise<IPCResult<any[]>>;
  getAccountLedgerReport: (filters: { accountIds?: string[]; startDate?: string; endDate?: string }) => Promise<IPCResult<any[]>>;
  getPaginatedBatches: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  getBatchSummary: () => Promise<IPCResult<{ status: string; count: number }[]>>;
  getKarigarConsumablesReport: (page: number, limit: number, filters: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  getKarigarConsumablesSummary: (filters: any) => Promise<IPCResult<any>>;
  getCustomerPurchaseLedgerReport: (filters: { partyIds?: string[]; itemIds?: string[]; startDate?: string; endDate?: string }) => Promise<IPCResult<any[]>>;
  getAccountStatement: (filters: { accountId: string; startDate?: string; endDate?: string }) => Promise<IPCResult<any[]>>;
  getLenaDenaReport: (filters: { groupId: string; startDate?: string; endDate?: string }) => Promise<IPCResult<any[]>>;
  createSaleVoucher: (dto: any) => Promise<IPCResult<{ voucherNo: string }>>;
  listSaleVouchers: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  ...
  listCashVouchers: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  ...
  listGoldVouchers: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  ...
  listSaleReturnVouchers: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  ...
  listCustomerOrders: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
  ...
  listSupplierOrders: (page: number, limit: number, filters?: any) => Promise<IPCResult<{ items: any[]; total: number }>>;
...
const api: ElectronAPI = {
  ...
  updateIssueRawMaterial: (id, dto) => ipcRenderer.invoke('inventory:update-issue-raw-material', id, dto),
  ...
  deleteReceivedFinishedProduct: (id) => ipcRenderer.invoke('manufacturing:delete-received-finished-product', id),
  ...
  updateReceivedFinishedProduct: (dto) => ipcRenderer.invoke('manufacturing:update-received-finished-product', dto),
  getPartyLedgerReport: (filters) => ipcRenderer.invoke('query:get-party-ledger-report', filters),
  getAccountLedgerReport: (filters) => ipcRenderer.invoke('query:get-account-ledger-report', filters),
  getPaginatedBatches: (page, limit, filters) => ipcRenderer.invoke('query:get-paginated-batches', page, limit, filters),
  getBatchSummary: () => ipcRenderer.invoke('query:get-batch-summary'),
  getKarigarConsumablesReport: (page, limit, filters) => ipcRenderer.invoke('query:get-karigar-consumables-report', page, limit, filters),
  getKarigarConsumablesSummary: (filters) => ipcRenderer.invoke('query:get-karigar-consumables-summary', filters),
  getCustomerPurchaseLedgerReport: (filters) => ipcRenderer.invoke('query:get-customer-purchase-ledger-report', filters),
  ...
  listSaleVouchers: (page, limit, filters) => ipcRenderer.invoke('query:list-sale-vouchers', page, limit, filters),
  ...
  listCashVouchers: (page, limit, filters) => ipcRenderer.invoke('query:list-cash-vouchers', page, limit, filters),
  ...
  listGoldVouchers: (page, limit, filters) => ipcRenderer.invoke('query:list-gold-vouchers', page, limit, filters),
  ...
  listSaleReturnVouchers: (page, limit, filters) => ipcRenderer.invoke('query:list-sale-return-vouchers', page, limit, filters),
  getNextSaleReturnVoucherNo: () => ipcRenderer.invoke('query:get-next-sale-return-voucher-no'),
  getSaleReturnVoucherDetails: (voucherId) => ipcRenderer.invoke('sale-return-voucher:get-details', voucherId),
  deleteSaleReturnVoucher: (voucherId) => ipcRenderer.invoke('sale-return-voucher:delete', voucherId),
  updateSaleReturnVoucher: (voucherId, dto) => ipcRenderer.invoke('sale-return-voucher:update', voucherId, dto),
  createCustomerOrder: (dto) => ipcRenderer.invoke('customer-order:create', dto),
  listCustomerOrders: (page, limit, filters) => ipcRenderer.invoke('query:list-customer-orders', page, limit, filters),
  getCustomerOrderDetails: (voucherId) => ipcRenderer.invoke('customer-order:get-details', voucherId),
  deleteCustomerOrder: (voucherId) => ipcRenderer.invoke('customer-order:delete', voucherId),
  updateCustomerOrder: (voucherId, dto) => ipcRenderer.invoke('customer-order:update', voucherId, dto),
  createSupplierOrder: (dto) => ipcRenderer.invoke('supplier-order:create', dto),
  listSupplierOrders: (page, limit, filters) => ipcRenderer.invoke('query:list-supplier-orders', page, limit, filters),
  getSupplierOrderDetails: (voucherId) => ipcRenderer.invoke('supplier-order:get-details', voucherId),
  deleteSupplierOrder: (voucherId) => ipcRenderer.invoke('supplier-order:delete', voucherId),
  updateSupplierOrder: (voucherId, dto) => ipcRenderer.invoke('supplier-order:update', voucherId, dto),
  ...
  updateAccountFreezeDate: (id, freezeDate) => ipcRenderer.invoke('account:update-freeze-date', id, freezeDate),
